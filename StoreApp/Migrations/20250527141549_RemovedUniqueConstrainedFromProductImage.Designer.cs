...
namespace StoreApp.Migrations
{
    ...
    [Migration("20250527141549_RemovedUniqueConstrainedFromProductImage")]
    partial class RemovedUniqueConstrainedFromProductImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreApp.Features.Authentication.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("StoreApp.Features.Cart.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("StoreApp.Features.Cart.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("StoreApp.Features.Cart.Models.UserCart", "UserCart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("StoreApp.Features.Cart.Models.UserCart", b =>
                {
                    b.HasOne("StoreApp.Features.Authentication.Models.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("StoreApp.Features.Cart.Models.UserCart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
